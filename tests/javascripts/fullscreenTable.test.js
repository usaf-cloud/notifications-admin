...
describe('FullscreenTable', () => {
  ...
  describe("when the table scrolls horizontally", () => {
    ...
    test("the left edge of the table scroll area should have a drop-shadow if it isn't scrolled", () => {
    ...
    test("the right edge of the table scroll area should have a drop-shadow if the table is scrolled to 100%", () => {
